...
from streambuild.compiler.discovery._helpers.testing.constants import (
    EXPECTED_CTE_PREFIX,
    REF_CTE_PREFIX,
...
from streambuild.compiler.discovery._helpers.testing.exceptions import SqlTestParseError
