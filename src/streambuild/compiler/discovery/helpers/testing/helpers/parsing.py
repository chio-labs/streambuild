...
from streambuild.compiler.discovery.helpers.testing.constants import (
    EXPECTED_CTE_PREFIX,
    REF_CTE_PREFIX,
...
from streambuild.compiler.discovery.helpers.testing.exceptions import SqlTestParseError
