...
from streambuild.executor.readiness.exceptions import DeploymentAuditExecutionError
...
def resolve_audit_deployment_id(
    *,
    ...
    if not candidates:
        raise DeploymentAuditExecutionError(
            "No staged deployment candidates are available for audit"
        )
