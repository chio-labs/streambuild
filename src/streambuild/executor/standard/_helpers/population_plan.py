"""Normalize a standard closure into the shared population contract."""
...
def build_standard_population_plan(
    *, plan: StandardPlan, realized_project: RealizedProject
) -> PopulationPlan:
    """Map standard logical scope to identity-named physical population."""
