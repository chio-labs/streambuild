...
def test_given_project_roles_when_operating_in_browser_then_effective_access_is_enforced(
    ...
    page.set_extra_http_headers({"X-StreamBuild-User": "bob"})
    ...
    page.set_extra_http_headers({"X-StreamBuild-User": "carol"})
    assert page.goto(f"{base_url}/status", wait_until="networkidle") is not None
    ...
    page.set_extra_http_headers({"X-StreamBuild-User": "dave"})
    assert page.goto(f"{base_url}/status", wait_until="networkidle") is not None
    ...
    page.set_extra_http_headers({"X-StreamBuild-User": "alice"})
    assert page.goto(f"{base_url}/status", wait_until="networkidle") is not None
    ...
    page.set_extra_http_headers({"X-StreamBuild-User": "kevin"})
    ...
    page.get_by_test_id("user-row-source-bob").click()
