...
from tests.unit.src.streambuild.clickhouse.render.helpers.create_kafka_table._test_types import (
    RenderCreateKafkaTableDdlTestCase,
)
from tests.unit.src.streambuild.clickhouse.render.helpers.create_kafka_table.helpers import (
    build_kafka_table,
)

TEST_CASES: list[RenderCreateKafkaTableDdlTestCase] = [
    RenderCreateKafkaTableDdlTestCase(
