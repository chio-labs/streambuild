...
<div class="flex flex-wrap items-center gap-2">
	<input bind:value={previewPathText} placeholder="preview field, e.g. data.source" class="bg-[var(--sb-inset)] w-[220px] rounded-[4px] border border-border px-2 py-1 font-mono text-[10.5px] outline-none focus:border-[var(--primary)]" onkeydown={(event) => { if (event.key === 'Enter') addPreviewPath(); }} />
